...
const int MAX_RETURN_HISTORY =
    12 * 200; // maximum number of months to keep track of returns
...
private:
  ...
  // TODO: consider if its better to generate returns on the fly to avoid over
  // generating
